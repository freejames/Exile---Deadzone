...
_spawnCenter = [7317.25,8440.95,0] ; //Center of your map -- this is Chernarus Isles  
...
_rescueStartPos = [[-1821.47,16497,0],[17827.8,14716.5,0],[17290.2,678.145,0],[-1713.73,-225.409,0]];   
...
_messagePatrol = "A NATO A10 Strike aircraft has been seen patrolling the Chernarus";
