...
///////////////////////// V0.2.6
///////////////////////// V0.2.7
class Land_i_House_Small_03_V1_F_Kit							{ quality = 2; price = 100000;sellPrice = 50;  };
class Land_i_House_Big_01_V2_F_Kit							{ quality = 2; price = 125000;sellPrice = 50;  };
class Land_PlasticCase_01_medium_F_Kit							{ quality = 1; price = 8000;sellPrice = 50;  };
class Land_Research_HQ_F_Kit							{ quality = 4; price = 200000;sellPrice = 50;  };
class Land_Research_house_V1_F_Kit							{ quality = 4; price = 100000;sellPrice = 50;  };
