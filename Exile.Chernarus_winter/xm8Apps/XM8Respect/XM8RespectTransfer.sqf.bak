...
/* CONFIG */
_minPlayers = 0; //if less than this # of players is online, nothing can be done
_maxPercent = 0; //keep this as a whole number.. Ex.. up to 20% loss would be 20
_fontStyle = 0;
/* CONFIG END */
...
OpenSlidePlayers = {
	...
	_display = uiNameSpace getVariable ["RscExileXM8", displayNull];
	_Ctrls = [7000,7001,7002,7003,7004,7005,7006,7007,7008,7009,7010,7011,8999];
	{
