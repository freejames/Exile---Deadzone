class CfgRestartWarnings
{
   class dynamic
   {
      interval = 4; // after how many hours of uptime the server will restart | ignore if using scheduled restarts
   };
   class scheduled
   {
   ...
   giveWarningsAt[] = {60,30,20,10,5,3,2,1}; // higher numbers before lower
   mode = 1; // 1 = non-scheduled | 2 = scheduled
};
